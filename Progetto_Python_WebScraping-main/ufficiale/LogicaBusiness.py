...
#         else:
#             self._id = id
#             diz = pers.leggiDettagli(self._id)
#             self._title = diz['titolo']
#             self._price = diz['prezzo']
#             self._release_date = diz['release_date']
#             self._description = diz['descrizione']
#             self._genres_str = diz['generi']
#             self._publisher = diz['editore']
#             self._game_url = diz['link']
#             self._image_url = diz['immagine']
#             self._stato = True
...
#         self._password = password
#         self._stato = True
#         diz = {'id': self._id, 'title': self._title, 'price': self._price, 'release_date': self._release_date,
#                'description': self._description, 'genres_str': self._genres_str, 'publisher': self._publisher,
#                'game_url': self._game_url, 'image_url': self._image_url, 'utenza': utenza, 'password': password}
#         pers.scriviDettagli(diz)
